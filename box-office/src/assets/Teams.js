        ...
        animations: [
          {
            elements: {
              eahDrPwe3GI10: {
                transform: {
                  data: { t: { x: -221.700882, y: -229.698423 } },
                  keys: {
                    o: [
                      {
                        t: 0,
                        v: { x: 221.700882, y: -210.301577, type: 'corner' },
                      },
                      {
                        t: 1000,
                        v: { x: 221.700882, y: 239.698423, type: 'corner' },
                        e: [0.42, 0, 0.58, 1],
                      },
                      {
                        t: 1100,
                        v: { x: 221.700882, y: 229.698423, type: 'corner' },
                        e: [0.42, 0, 0.58, 1],
                      },
                      {
                        t: 1200,
              ...
              eahDrPwe3GI25: {
                transform: {
                  data: { t: { x: -256.849998, y: -235.678799 } },
                  keys: {
                    o: [
                      {
                        t: 0,
                        v: { x: 256.849998, y: -194.321201, type: 'corner' },
                      },
                      {
                        t: 400,
                        v: { x: 256.849998, y: -194.321201, type: 'corner' },
                      ...
                      {
                        t: 1200,
                        v: { x: 256.849998, y: 225.678799, type: 'corner' },
                      },
                      {
                        t: 1300,
                        v: { x: 256.849998, y: 215.678799, type: 'corner' },
                      },
                      {
                        t: 1400,
                        v: { x: 256.849998, y: 225.678799, type: 'corner' },
            ...
            s: '',
          },
        ],
        options: 'MADAxMDg4MmY4MDgxNmJU3ZjgxMmY0NzJmNzkL3YzZlWDcxMmZOOGE/O',
      },
      '__SVGATOR_PLAYER__',
      window
    );
